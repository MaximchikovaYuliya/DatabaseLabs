use master;
go
create database M_UNIVER
on primary
( name = N'M_UNIVER_mdf', filename = N'D:\4_semestr\BD\M_UNIVER\M_UNIVER_mdf.mdf', 
   size = 5Mb, maxsize=10Mb, filegrowth=1Mb),
( name = N'M_UNIVER_ndf', filename = N'D:\4_semestr\BD\M_UNIVER\M_UNIVER_ndf.ndf', 
   size = 5Mb, maxsize=10Mb, filegrowth=10%),
filegroup G1
( name = N'M_UNIVER11_ndf', filename = N'D:\4_semestr\BD\M_UNIVER\M_UNIVER11_ndf.ndf', 
   size = 10Mb, maxsize=15Mb, filegrowth=1Mb),
( name = N'M_UNIVER12_ndf', filename = N'D:\4_semestr\BD\M_UNIVER\M_UNIVER12_ndf.ndf', 
   size = 2Mb, maxsize=5Mb, filegrowth=1Mb),
filegroup G2
( name = N'M_UNIVER21_ndf', filename = N'D:\4_semestr\BD\M_UNIVER\M_UNIVER21_ndf.ndf', 
   size = 5Mb, maxsize=10Mb, filegrowth=1Mb),
( name = N'M_UNIVER22_ndf', filename = N'D:\4_semestr\BD\M_UNIVER\M_UNIVER22_ndf.ndf', 
   size = 2Mb, maxsize=5Mb, filegrowth=1Mb)
log on
( name = N'M_UNIVER_log', filename=N'D:\4_semestr\BD\M_UNIVER\M_UNIVER_log.ldf',       
...
insert into PULPIT   (PULPIT,    PULPIT_NAME,FACULTY)
   values  ('ТЭХПиМЭТ', 'Химии, технологии электрохимических производств и материалов электронной техники', 'ХТиТ')
insert into PULPIT   (PULPIT,    PULPIT_NAME,FACULTY)
   values  ('ОВ', 'Туризма, природопользования и охотоведения', 'ЛХФ')
insert into PULPIT   (PULPIT,    PULPIT_NAME,FACULTY)
   values  ('ТНХСиППМ', 'Физической, коллоидной и аналитической химии', 'ТОВ')   
...
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT )
            values ('ПЭХ',    'Прикладная электрохимия','ТЭХПиМЭТ') 
